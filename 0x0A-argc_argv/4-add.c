...
#include <stdbool.h> /* use bool data type */

/**
 * is_num - iterate through each argv to test if it's a number
 * @argvv: a argv
 * Return: is true only if entire string is a number, false if not
 */
...
/**
 * main - print sum if all arguments given that are numbers
